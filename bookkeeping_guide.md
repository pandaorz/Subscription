...
## 📂 情境六：支付工具最佳化 (Payment Optimization)

### 1. 刷卡策略查詢 (Best Card)
* **指令**：`Agent，我要去好市多加油，請問用哪張卡回饋最高？` 或 `我要繳學費了，請問目前哪張卡有分期零利率？`
* **功能**：根據 subscriptions.md 的「信用卡與支付優惠管理」區段，提供當下最佳建議。

### 2. 優惠變更更新 (Benefit Update)
* **指令**：`玉山 U Bear 卡網購回饋改了，現在只有 2%，上限 200 元。請幫我更新 MD 檔。`
* **功能**：隨時維護優惠資訊的正確性。

### 3. 到期與剪卡提醒 (Expiry Check)
* **指令**：`檢查有沒有哪張卡快過期了？或是有些「優惠期間」已經結束的項目？`
* **功能**：避免使用已過期的優惠或卡片。
